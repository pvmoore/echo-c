...
typedef  __declspec(align(16)) __declspec(deprecated) struct A1 {
    int Low;
} A1;

typedef __declspec(align(16)) __declspec(deprecated) union {
    int Low;
} A2;

typedef __declspec(align(16)) __declspec(deprecated) enum {
    Low,
    High
} A3;
